...
// 验权
import { getToken, updateToken, removeToken, removeRefreshToken, setUuid, removeUuid, getRefreshToken } from '@/utils/auth'
...
export default {
     ...
     */
        refreshToken({
            ...
            return new Promise(async(resolve, reject) => {
                await refreshAccessToken(getRefreshToken()).then(response => {
                    const data = response.data
                    // 更新token信息
                    updateToken(data)
                    resolve(data)
