...
<script>
import { queryPageList } from '@/api/platform/bo/boDef'
import { createTableOptions } from './constants'
      ...
      listConfig: {
        ...
        searchForm: {
          ...
          forms: [
            ...
            { prop: 'Q^code_^SL', label: '编码', itemWidth: '200' }
          ]
        },
        // 表格字段配置
        columns: [
          ...
          { prop: 'isCreateTable', label: '生成表', tags: createTableOptions }
        ]
      },
      pagination: {},
      sorts: {}
