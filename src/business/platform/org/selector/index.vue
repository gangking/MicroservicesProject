...
<script>
import { get as getEmployee } from '@/api/platform/org/employee'
import { get as getOrg } from '@/api/platform/org/org'
import { get as getPosition } from '@/api/platform/org/position'
import { get as getRole } from '@/api/platform/org/role'
...
export default {
    ...
    watch: {
        value: {
            handler(val, oldVal) {
                console.log('fdsfsdfjdls:valuewatch:', val)
                this.initData()
     ...
     */
        initData() {
            ...
            console.log('........data我找真不容易:', data, this.value)
