    ...
    <div v-for="(item,index) of conditions" :key="index" class="content">
      ...
      <div class="right">
        <div>
          ...
          <div>
            <el-button type="success" plain @click="handleSignResult('agree',item)">同意</el-button>
            <el-button type="danger" plain @click="handleSignResult('oppose',item)">反对</el-button>
          </div>
        </div>
