...
<script>
import { findTreeData, remove } from '@/api/platform/compform/type'
import ActionUtils from '@/utils/action'

import TypeEdit from '@/views/platform/catree/type/edit'
import TypeSort from '@/views/platform/catree/type/sort'
...
export default {
  ...
  methods: {
    loadTreeData() {
      findTreeData({ 'bizTypeKey': this.categoryKey }).then(response => {
