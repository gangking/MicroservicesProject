...
!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.vaildData = e.getPasswordChar = e.findArray = e.findArrayLabel = e.getObjValue = e.getDeepData = e.findLabelNode = e.detailDicGroup = e.filterDefaultParams = e.findByValue = e.detailDic = e.detailDataType = e.setPx = e.sortArrys = e.deepClone = e.isJson = e.getObjType = void 0);
      var s =
      ...
      (e.hasOwn = i), (e.getFixed = o), (e.dataURLtoFile = r), (e.randomId = a);
      var l = n(10),
        u = n(12),
        c = Object.prototype.hasOwnProperty,
        d = (e.getObjType = function(t) {
          ...
          var e =
            ...
            n =
              arguments.length > 1 && void 0 !== arguments[1]
                ...
                : {},
            i = arguments[2],
            o = n.value || u.DIC_PROPS.value,
            r = n.children || u.DIC_PROPS.children;
          return (
            e.forEach(function(e) {
              (e[o] = p(e[o], i)), e[r] && t(e[r], n, i);
            }),
            e
          );
        }),
        (e.findByValue = function(t, e, n, i) {
          if ((0, l.validatenull)(t)) return e;
          var o = "";
          if (((n = n || u.DIC_PROPS), e instanceof Array)) {
            o = [];
            for (var r = 0; r < e.length; r++) {
              var a = e[r];
              i ? o.push(m(t, a, n) || a) : o.push(y(t, a, n));
            }
            o = o.join(u.DIC_SPLIT).toString();
          } else
        ...
        (e.filterDefaultParams = function(t) {
          ...
          if (e) return n;
          for (var i in n)
            (-1 !== i.indexOf("$") || (0, l.validatenull)(n[i])) && delete n[i];
          return n;
        }),
        ...
        m = (e.findLabelNode = function(t, e, n) {
          t = h(t);
          var i = "";
          return (
            (function t(e, n, o) {
              for (
                var r = o.label || u.DIC_PROPS.label,
                  a = o.value || u.DIC_PROPS.value,
                  s = o.children || u.DIC_PROPS.children,
                  l = 0;
                l < e.length;
                l++
              ) {
        ...
        v = (e.getDeepData = function(t) {
          return (Array.isArray(t) ? t : t.data) || [];
        }),
        y = ((e.getObjValue = function(t) {
          var e =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : "",
        ...
        (e.findArrayLabel = function(t, e, n) {
          t = h(t);
          for (
            var i = n.value || u.DIC_PROPS.value,
              o = n.label || u.DIC_PROPS.label,
              r = 0;
            r < t.length;
            r++
          )
      ...
      (e.findArray = function(t, e, n) {
        (t = h(t)), (n = n || u.DIC_PROPS.value);
        for (var i = 0; i < t.length; i++) if (t[i][n] === e) return i;
        return -1;
      }),
        ...
        (e.vaildData = function(t, e) {
          return "boolean" == typeof t ? t : (0, l.validatenull)(t) ? e : t;
        });
    },
    function(t, e, n) {
      "use strict";
        ...
        (e.getSearchType = function(t) {
          ...
          return (
            ["select", "radio", "checkbox", "switch"].includes(n)
              ...
              : ["cascader"].includes(n)
              ? (o = "cascader")
              : ["number"].includes(n) && (o = "input-number"),
          ...
          return {
            ...
            computed: {
              ...
              isMediumSize: function() {
                return "medium" === this.controlSize
                  ? "small"
                  : this.controlSize;
              },
              controlSize: function() {
                return (
                  this.tableOption.size || (this.$AVUE || {}).size || "medium"
                );
              }
            },
            methods: {
              ...
              handleLoadDic: function(t) {
                ...
                return new Promise(function(n) {
                  if (e.vaildData(e.tableOption.dicFlag, !0))
                    ...
                    var o = e.tableOption.dicData || [];
                    (e.DIC = e.deepClone(o)), n();
                  }
                });
              },
                            ...
                            Object.assign(
                              {
                                url:
                                  "" +
                                  n.dicUrl.replace("{{key}}", t[n.parentProp])
                              },
                              {
                                resKey: (n.props || {}).res,
                                method: n.dicMethod,
    ...
    function(t, e, n) {
      ...
      e.default = (0, a.default)({
        ...
        i(o, "size", {
          validator: function(t) {
            return (
              "number" == typeof t || ["small", "large", "default"].includes(t)
            );
          },
          default: "default"
        }),
    ...
    function(t, e, n) {
      ...
      e.default = (0, a.default)({
        ...
        methods: {
          ...
          menuIcon: function(t) {
            return "icon" === this.menuType ? "" : this.t("crud." + t);
          },
          menuText: function(t) {
          ...
          findColumnIndex: function(t) {
            return this.findArray(this.propOption, t, "prop");
          },
            ...
            return (
              n.length > 0 &&
                n.forEach(function(t, n) {
                  ...
                  if (0 === n)
                    o[n] = e.tableOption.sumText || D.default.sumText;
                  else if (r)
                    switch (r.type) {
                      case "count":
                        o[n] = "计数:" + i.length;
            ...
            return (function(i) {
              ...
              return (
                ...
                (o = Object.assign(o, {
                  ...
                  submitText: t.vaildData(e.searchSubText, "查询"),
                  submitBtn: t.vaildData(e.searchSubBtn, t.config.searchSubBtn),
                  submitIcon: e.searchBtnIcon || t.config.searchBtnIcon,
                  emptyText: t.vaildData(e.searchResetText, "清空"),
                  emptyBtn: t.vaildData(
                    e.searchResetBtn,
                    t.config.searchResetBtn
                  ),
          ...
          handleChange: function(t, e) {
            ...
            this.validatenull(a) ||
              ...
              (0, u.sendDic)({
                ...
                if (
                  (n.$set(n.crud.cascaderDIC[l], d, i),
                  !n.validatenull(i) && n.crud.formIndexList.includes(l))
                ) {
                  var o = i[c.defaultIndex || 0];
                  o || (o = i[0]),
                    o &&
                      (e[c.prop] =
                        o[
                          (c.props || n.crud.parentOption.props || {}).value ||
                            "value"
                        ]);
                }
              }));
      ...
      e.default = (0, r.default)({
        ...
        methods: {
          dateChange: function(t) {
            this.$parent.$emit("date-change", t);
          }
        }
      });
    },
      ...
      e.default = (0, a.default)({
        ...
        methods: {
          ...
          closeDialog: function() {
            (this.tableIndex = -1), (this.tableForm = {}), this.hide();
          },
          hide: function() {
            var t = this,
              e = function() {
      ...
      e.default = (0, r.default)({
        ...
        methods: {
          ...
          handleClose: function(t) {
            (this.imgSrc = void 0), (this.videoSrc = void 0), t();
          },
          addKey: function() {
            "" !== this.keys &&
        ...
        methods: ((a = {
          ...
          findColumnIndex: function(t) {
            var e = this,
              ...
              o = void 0;
            return (
              this.columnOption.forEach(function(n, r) {
                var a = e.findArray(n.column, t, "prop");
                -1 !== a && (i.push(r), i.push(a), (o = a));
              }),
              n ? i : o
            );
          },
          updateDic: function(t, e) {
            var n = this,
              i = this.findColumnIndex(t, !0),
              o = i[0],
              r = i[1],
              a = this.columnOption[o].column[r];
            this.validatenull(e) && !this.validatenull(a.dicUrl)
              ? (0, y.sendDic)({
                  url: a.dicUrl,
                  resKey: (a.props || {}).res
                }).then(function(e) {
            ...
            setTimeout(function() {
              ...
              n.validatenull(o) ||
                ...
                (0, y.sendDic)({
                  ...
                  if (
                    (n.$set(n.DIC, l, e),
                    !n.validatenull(e) && n.formList.includes(r))
                  ) {
                    var i = e[s.defaultIndex || 0];
                    i || (i = e[0]),
                      i &&
                        ((n.form[s.prop] =
                          i[
                            (s.props || n.parentOption.props || {}).value ||
                              "value"
                          ]),
                        n.clearValidate());
                  }
    ...
    function(t, e, n) {
      ...
      e.default = (0, r.default)({
        name: "date",
        mixins: [(0, l.default)(), (0, c.default)(), f.default],
        data: function() {
          return {
            text: "",
            menu: [],
            datetime: [(0, a.GetDateStr)(0), (0, a.GetDateStr)(30)]
          };
        },
        props: {
        ...
        computed: {
          isDategroup: function() {
            return "dategroup" === this.type;
          }
        },
        watch: {
          text: {
        ...
        methods: {
          ...
          init: function() {
            (this.menu = [
              { label: this.t("date.t"), value: (0, a.GetDateStr)(0) },
              { label: this.t("date.y"), value: (0, a.GetDateStr)(-1) },
              {
                label: this.t("date.n"),
                value: (0, a.GetDateStr)(-7) + "," + (0, a.GetDateStr)(0)
              },
              { label: this.t("date.a"), value: "" }
            ]),
              this.default &&
                ((this.text = (0, a.GetDateStr)(0)),
      ...
      e.default = (0, o.default)({
        ...
        methods: {
          ...
          rangeMouseUp: function() {
            this.$emit("blur"), (this.rangeActive = !1);
          },
          ...
          handleMouseMove: function(t) {
            ...
            this.moveActive &&
              ...
              (window.onmousemove = function(t) {
                ...
                var n = t.clientX,
                  i = t.clientY;
                (e.baseLeft = (0, r.getFixed)(e.baseLeft + (n - e.x) * e.step)),
                  (e.baseTop = (0, r.getFixed)(e.baseTop + (i - e.y) * e.step)),
                  (e.x = n),
                  (e.y = i);
              });
          },
          handleMouseUp: function() {
            this.$emit("blur"), (this.moveActive = !1);
          }
        }
      });
    },
      ...
      e.default = (0, o.default)({
        ...
        methods: {
          init: function() {
            ...
            (i.src = this.img),
              (i.onload = function() {
                var e = t.option.width || i.width,
                  o = t.option.width
                    ? (i.height / i.width) * t.option.width
                    : i.height;
                (t.$refs.canvas.width = e),
                  (t.$refs.canvas.height = o),
                  n.drawImage(i, 0, 0, e, o),
                      ...
                      (e.src = t.img),
                        (e.onload = function() {
                          var i = t.width || e.width,
                            o = t.width
                              ? (e.height / e.width) * t.width
                              : e.height;
                          n.drawImage(e, t.left, t.top, i, o);
                        });
                    } else t.bold ? (n.font = "bold " + t.size + "px " + t.style) : (n.font = t.size + "px " + t.style), (n.fillStyle = t.color), n.fillText(t.text, t.left, t.top), n.stroke();
                  });
              });
          },
          getFile: function() {
            var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : new Date().getTime(),
              e = this.canvas.toDataURL("image/jpeg", 1);
            return this.dataURLtoFile(e, t);
          },
          getBase64: function() {
    ...
    function(t, e, n) {
      ...
      e.default = (0, s.default)({
        ...
        methods: {
          ...
          handleChange: function(t) {
            var e = (this.text,
            this.isString && this.multiple ? t.join(",") : t);
            "function" == typeof this.change &&
              this.change({ value: e, column: this.column }),
              this.$emit("input", e),
              this.$emit("change", e);
      ...
      e.default = (0, r.default)({
        ...
        methods: {
          ...
          handleError: function(t) {
            console.log(new Error(t)), this.$message.error(t || "上传失败");
          },
          delete: function(t) {
            var e = this;
          ...
          handlePreview: function(t) {
            if (!this.disabled)
              if ("function" == typeof this.uploadPreview)
                this.uploadPreview(t, this.column);
              else {
                if (
                  ((this.dialogImageUrl = t.url),
                  !/\.(gif|jpg|jpeg|png|GIF|JPG|PNG)/.test(t.url))
                )
                  return (
                    (this.dialogImgType = !1),
                    void window.open(this.dialogImageUrl)
                  );
                (this.dialogImgType = !0), (this.dialogVisible = !0);
              }
          },
      ...
      e.default = (0, r.default)({
        ...
        methods: {
          ...
          updateChart: function() {
            var t,
              e = this,
              n = this.deepClone(this.mapList);
            window.echarts.registerMap("HK", n);
            var o = {
              tooltip: (function() {
                return Object.assign(
                  (function() {
                    return e.formatter
                      ? {
                          formatter: function(t) {
                            return e.formatter(t, e.dataChart);
                          }
                        }
                      : {};
                  })(),
                  {
                    backgroundColor: "rgba(0,0,0,1)",
                    textStyle: {
                      fontSize: e.option.tipFontSize,
                      color: e.option.tipColor || "#fff"
                    }
                  }
                );
              })(),
              geo: Object.assign(
                (function() {
                  return e.validatenull(e.centerData)
                    ? {}
                    : { center: e.centerData };
                })(),
                ((t = {
                ...
                i(t, "left", this.option.gridX),
                i(t, "top", this.option.gridY),
                i(t, "right", this.option.gridX2),
                i(t, "bottom", this.option.gridY2),
                i(t, "emphasis", {
                  label: { color: this.empColor },
                  itemStyle: { areaColor: this.empAreaColor }
                }),
                i(t, "itemStyle", {
              ...
              series: [
                {
                  ...
                  emphasis: {
                    ...
                    itemStyle: { color: this.option.empColor }
                  }
                }
              ]
            };
            this.myChart.on("mouseover", function() {
              clearInterval(e.bannerCheck), e.resetBanner();
            }),
              this.myChart.on("mouseout", function() {
                (e.bannerCount = 0), e.setBanner();
              }),
              this.myChart.on("georoam", function(t) {
                var n = e.myChart.getOption(),
                  i = n.geo[0];
                (e.centerData = i.center),
                  (e.zoomData = i.zoom),
                  e.zoomData < 1 && (e.zoomData = 1);
              }),
              this.myChart.resize(),
              this.myChart.setOption(o, !0);
          }
        }
      });
    },
                    ...
                    [
                      {
                        ...
                        fn: function(e) {
                          var n = e.size;
                          return [t._t("searchMenu", null, { size: n })];
                        }
                      },
                  ...
                  [
                    ...
                    t.vaildData(
                      ...
                      ? n("el-button", {
                          ...
                          attrs: {
                            icon: t.config.searchBoxBtnIcon,
                            circle: "",
                            size: t.crud.isMediumSize
                          },
                          on: {
    ...
    function(t, e, n) {
      ...
      var i = function() {
          var t = this,
            e = t.$createElement,
            n = t._self._c || e;
          return t.vaildData(t.$parent.tableOption.title, !1) ||
            t.vaildData(t.$parent.tableOption.dateBtn, t.config.dateBtn)
            ? n(
                "div",
                {
                  class: t.b("title"),
                ...
                [
                  n("p", [t._v(t._s(t.$parent.tableOption.title))]),
                  t.vaildData(t.$parent.tableOption.dateBtn, t.config.dateBtn)
                    ? n("avue-date", {
                        attrs: {
                          type: "dategroup",
                          default: t.vaildData(
                            t.$parent.tableOption.dateDefault,
                            t.config.dateDefault
                          ),
          ...
          return n(
            ...
            [
              ...
              n(
                ...
                [n("template", { slot: "search" }, [t._t("search")], 2)],
                2
              ),
              n(
                "header-menu",
              ...
              n("dialog-form", {
                ref: "dialogForm",
                attrs: { columnFormOption: t.columnFormOption },
                scopedSlots: t._u(
                  [
                    t._l(t.columnFormOption, function(e) {
                      return {
              ...
              n("dialog-column", { ref: "dialogColumn" }),
                    ...
                    n(
                      ...
                      [
                        ...
                        t.vaildData(t.formSafe.parentOption.emptyBtn, !0)
                          ...
                          : t._e(),
                        t._t("menuForm", null, { size: t.formSafe.controlSize })
                      ],
                      2
                    )
                  ])
                      ...
                      [
                        n("el-date-picker", {
                          attrs: {
                            ...
                            "start-placeholder": t.t("date.start"),
                            "end-placeholder": t.t("date.end")
                          },
                          on: { focus: t.handleFocus, change: t.handleChange },
                          model: {
                            value: t.datetime,
                            callback: function(e) {
                              t.datetime = e;
            ...
            "div",
            {
              ...
              on: {
                mouseover: function(e) {
                  e.stopPropagation(), !t.disabled && t.handleMouseOver(e);
                },
                mouseout: function(e) {
                  e.stopPropagation(), !t.disabled && t.handleMouseOut(e);
                },
                mousedown: function(e) {
                  e.stopPropagation(), !t.disabled && t.handleMouseDown(e);
                },
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            ...
            [
              n("canvas", { ref: "canvas", attrs: { id: "canvas" } }),
              t._t("default")
            ],
            2
          );
    ...
    function(t, e, n) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 });
      var r = ((e.getToken = function(t, e, n) {
                      ...
                      n(
                        ...
                        [
                          t.vaildData(t.option.addBtn, !0)
                            ...
                            : t._e(),
                          n("template", { slot: "append" }, [t._t("addBtn")], 2)
                        ],
                        2
                      )
                    ],
          ...
          return n(
            ...
            [
              n(
                ...
                [
                  n("template", { slot: "append" }, [n("i", { class: t.text })])
                ],
                2
              ),
              n(
      ...
      e.default = (function() {
        return {
          props: {
            ...
            id: { type: String, default: "main_" + new Date() },
          ...
          computed: {
            ...
            styleChartName: function() {
              return {
                width: (0, i.setPx)(this.minWidth || this.width),
                height: (0, i.setPx)(this.height)
              };
            },
          ...
          methods: {
            ...
            updateData: function() {
              ...
              if ((this.resetData && this.resetData(), !this.key)) {
                ...
                var e = function() {
                  if (((t.key = !1), t.isApi)) {
                    var e = t.dataUrl.replace("${HOME_URL}", t.homeUrl),
                      n = function(e) {
                        var n =
                        ...
                        if (t.dataAppend)
                          for (var o = 0; o < i.length; o++)
                            !(function(e) {
                              e === i.length - 1 &&
                                (t.propQuery.datetime = i[e][t.datetime]),
                                t.dataCount++,
                                setTimeout(function() {
                                  t.dataChart.unshift(i[e]);
                                }, 1500 * t.dataCount);
                            })(o);
                        else t.dataChart = i;
                        t.isChart &&
                    ...
                    if ("get" === t.dataMethod)
                      t.$httpajax
                        .get(e, {
                          params: Object.assign(t.dataQuery, t.propQuery)
                        })
                        .then(function(t) {
                          n(t);
                        });
                    else if ("post" === t.dataMethod) {
                      var i = {},
                        o = e;
                      if (o.includes("?")) {
                        var r = o.indexOf("?");
                      ...
                      t.$httpajax
                        .post(e, Object.assign(t.dataQuery, i, t.propQuery))
                        .then(function(t) {
                          n(t);
                        });
                    }
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-bar",
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-pie",
              style: t.styleSizeName
            },
            [
              n("div", {
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-line",
              style: t.styleSizeName
            },
            [n("div", { ref: t.id, style: t.styleChartName })]
          );
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-wordCloud",
              style: t.styleSizeName
            },
            [n("div", { ref: t.id, style: t.styleChartName })]
          );
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-gauge",
              style: t.styleSizeName
            },
            [n("div", { ref: t.id, style: t.styleChartName })]
          );
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-map",
              style: t.styleSizeName,
              on: {
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-img",
              style: t.styleSizeName,
              on: { click: t.handleClick }
            },
            [
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-imgborder",
              style: t.styleSizeName
            },
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-slide",
              style: t.styleSizeName
            },
            [
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-radar",
              style: t.styleSizeName
            },
            [n("div", { ref: t.id, style: t.styleChartName })]
          );
    ...
    function(t, e, n) {
      ...
      var i = function() {
          ...
          return n(
            "div",
            {
              staticClass: "avue-echart avue-echart-funnel",
              style: t.styleSizeName
            },
            [n("div", { ref: t.id, style: t.styleChartName })]
          );
