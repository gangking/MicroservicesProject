export default {
    loading: '加载中',
    company: 'BeEver企业应用中台软件',
    copyright: '版权所有',
    platform: ' BeEver企业应用中台软件',
    welcome: '欢迎使用  BeEver企业应用中台软件',
    route: {
        untitled: '未命名',
        login: '登录',
        register: '注册账号',
    ...
    formula: {
        ...
        mid: {
            ...
            'example': 'MID("文思海辉快速开发平台",4,6)返回"快速开发平台"'
        },
        min: {
        ...
        replace: {
            ...
            'example': 'REPLACE("文思海辉快速开发平台",4,6,"企业数据管理平台")返回"文思海辉企业数据管理平台"'
        },
        rept: {
            'intro': 'REPT函数可以将文本重复一定次数',
            'usage': 'REPT(文本,重复次数)',
            'example': 'REPT("文思海辉",3)返回"文思海辉文思海辉文思海辉"'
        },
        right: {
        ...
        search: {
            ...
            'example': 'SEARCH("2016","文思海辉2016")返回4'
        },
        second: {
        ...
        split: {
            ...
            'example': 'SPLIT("文思海辉-快速开发平台","-")返回"文思海辉，快速开发平台"'
        },
        systime: {
