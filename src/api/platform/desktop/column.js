...
export function queryPageList(data) {
  return request({
    url: SYSTEM_URL + '/base/v3/desktop/column/query',
    method: 'post',
    data: data
  })
}
...
export function remove(params) {
  return request({
    url: SYSTEM_URL + '/base/v3/desktop/column/remove',
    method: 'post',
    params: params
  })
}
...
export function save(params) {
  return request({
    url: SYSTEM_URL + '/base/v3/desktop/column/save',
    method: 'post',
    data: params
  })
}
...
export function get(params) {
  return request({
    url: SYSTEM_URL + '/base/v3/desktop/column/get',
    method: 'get',
    params: params
  })
}
...
export function initTemplate() {
  return request({
    url: SYSTEM_URL + '/base/v3/desktop/column/initTemplate',
    method: 'post'
  })
}
...
export function setEnable(params) {
  return request({
    url: SYSTEM_URL + '/base/v3/desktop/column/setEnable',
    method: 'post',
    params: params
  })
}
...
export function findHashRightsColumn(params) {
  return request({
    url: SYSTEM_URL + '/base/v3/desktop/column/findHashRightsColumn?',
    method: 'get',
    params: params
  })
}
...
export function getData({ alias, dataMode, dataFrom }, params) {
  ...
  // } else {
  //   return request({
  //     url: SYSTEM_URL + '/base/v3/desktop/column/getData',
  //     method: 'post',
