...
export function remove(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/remove',
    method: 'post',
    params: params
  })
}
...
export function get(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/get',
    method: 'get',
    params
  })
}
...
export function manage(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/manage',
    method: 'post',
    params
  })
}
...
export function findTreeData(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/getBoTree',
    method: 'post',
    params
  })
}
...
export function setCategory(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/setCategory',
    method: 'post',
    params: params
  })
}
...
export function queryVersionsList(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/queryByCode',
    method: 'post',
    data: params
  })
}
...
export function checkCode(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/checkCode',
    method: 'post',
    params: params
  })
}
...
export function getBindForm(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/getBindForm',
    method: 'post',
    params: params
  })
}
...
export function getJsonByTbl(data) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/getJsonByTbl/vo',
    method: 'post',
    data
  })
}
...
export function getJson(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/getJson',
    method: 'get',
    params
  })
}
...
export function synBoTable(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/synBoTable',
    method: 'post',
    params: params
  })
}
...
export function genBoTable(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/genBoTable',
    method: 'post',
    params: params
  })
}
...
export function saveCopy(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/copy',
    method: 'post',
    params: params
  })
}
...
export function setMainVersion(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/setMainVersion',
    method: 'post',
    params: params
  })
}
...
export function importBo(file) {
  ...
  return request({
    ...
    url: FORM_URL + '/model/v3/bo/def/importBo',
    method: 'post',
    data: data
  })
}
...
export function exportFile(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/exportBo',
    method: 'post',
...
export function queryTable(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/queryTable',
    method: 'post',
    params
  })
}
...
export function findBoDefByPid(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/findBoDefByPid',
    method: 'get',
    params
  })
}
...
export function queryBoDefByIds(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/queryBoDefByIds',
    method: 'post',
    params
  })
}
...
export function findBoDefBySid(params) {
  return request({
    url: FORM_URL + '/model/v3/bo/def/findBoDefBySid',
    method: 'get',
    params
  })
}
