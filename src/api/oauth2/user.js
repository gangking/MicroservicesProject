...
const CLIENT_ID = process.env.VUE_APP_MOA_CLIENT_ID
const CLIENT_SECRET = process.env.VUE_APP_MOA_CLIENT_SECRET;
...
export function logout(access_token) {
  return request({
    url: OAUTH2_URL + '/auth/v3/user/logout',
    method: 'post',
    params: {
...
export function getValidCode() {
  return request({
    url: OAUTH2_URL + '/auth/v3/user/captcha',
    method: 'get'
  })
}
...
export function getUserInfo(username) {
  return request({
    url: OAUTH2_URL + '/auth/v3/user/context',
    method: 'post',
    params: {
      username
    }
...
export function switchUser({ username, token }) {
  return request({
    url: OAUTH2_URL + '/auth/v3/authentication/switch',
    method: 'post',
    data: {
      'client_id': CLIENT_ID,
...
export function exitSwitchUser({ username, token }) {
  return request({
    url: OAUTH2_URL + '/auth/v3/auth/v3/authentication/switch/exit',
    method: 'post',
    data: {
      'client_id': CLIENT_ID,
      'client_secret': CLIENT_SECRET,
...
export function getRegisterOpen() {
  return request({
    url: OAUTH2_URL + '/auth/v3/user/open',
    method: 'get'
  })
}
...
export function register(params) {
  return request({
    url: OAUTH2_URL + '/user/v3/user/register',
    method: 'post',
    data: params
  })
}
...
export function sendSms(params) {
  return request({
    url: OAUTH2_URL + '/auth/v3/user/send/sms',
    method: 'get',
    params: params
  })
}
...
export function resetPasswd(params) {
  return request({
    url: OAUTH2_URL + '/user/v3/user/reset/passwd',
    method: 'post',
    data: params
  })
}
