<template>
  <div class="bg" id="longTrem" v-loading="bgLoading" element-loading-text="发送中,请等待">
    <!-- <div class="title">
      <span>长期在制订单</span>
    </div>-->
    ...
    <div class="table-content" :style="{height:height+'px'}">
      ...
      >
        ...
        <el-table-column prop="aufnr" label="订单号" width="110"></el-table-column>
        <el-table-column prop="matnr" label="物料"></el-table-column>
        <el-table-column prop="maktx" label="物料描述" width="150"></el-table-column>
...
import { downLong, saveLong } from "@/api/platform/monitor/monHandle";
...
export default {
  ...
  methods: {
    ...
    getTable(limit = 20, pageno = 1) {
      ...
      searchLong(params).then(response => {
        this.loading = false;
    ...
    //计算中间table高度
    getTableHeight() {
      if (document.querySelector("#longTrem")) {
        let height = document.querySelector("#longTrem").clientHeight;
        // console.log(height, "height整体");
        let btnHeight = document.querySelector("#longTrem .header-btn")
          .clientHeight;
        // console.log(btnHeight, "btnHeight整体");
        let inputHeight = document.querySelector("#longTrem .header-input")
          .clientHeight;
        //console.log(inputHeight, "inputHeight中间的输入框");
        let footerHeight = document.querySelector("#longTrem .footer")
          .clientHeight;
