...
<script>
import { remove, queryPageList } from '@/api/platform/cat/dictionary'
import { remove as removeType, exportXml, findTreeData } from '@/api/platform/cat/type'
...
export default {
  ...
  data() {
    return {
      ...
      treeContextmenus: [
        { icon: 'add', label: '添加字典分类', value: 'add' },
        { icon: 'add', label: '添加私有字典分类', value: 'addPrivate', rights: ['node'] },
        { icon: 'edit', label: '编辑字典分类', value: 'edit', rights: ['node'] },
        { icon: 'delete', label: '删除字典分类', value: 'remove', rights: ['node'] },
        { type: 'divided', rights: ['node'] },
        { icon: 'export', label: '导出', value: 'export', rights: ['node'] },
        { icon: 'import', label: '导入', value: 'import', rights: ['node'] },
        { type: 'divided' },
