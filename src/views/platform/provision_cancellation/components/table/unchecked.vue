...
export default {
  ...
  methods: {
    ...
    gettableData() {
      ...
      postingTimeStart = this.selecForm.postingTimeStart != '' ? this.selecForm.postingTimeStart  : '';
      endTimeEnd = this.selecForm.endTimeEnd != '' ? this.selecForm.endTimeEnd  : '';

      reBudatStart =
        this.selecForm.reBudatStart != '' ? this.selecForm.reBudatStart : '';
      ...
      // return request({
      //   baseURL: BASE_GATEWAY_API,
      //   url: COMP_URL + "/bpm/v3/bpm/received/query/ccToBeRead",
      //   method: "post",
      //   data: {
      //     extraParameters: {
      //       appIds: this.appId,
