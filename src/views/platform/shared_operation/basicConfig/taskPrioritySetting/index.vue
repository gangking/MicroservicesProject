<template>
  <div class="box">
    <Layout>
      <leftLayout :condtion="condtion" :condtionAttr="condtionAttr" slot="left" @isEditableFunc="isEditableFunc" @getGroupGoPage="getGroupGoPage" @getActiveBusObj="getActiveBusObj" @activePriority="activePriority" />
