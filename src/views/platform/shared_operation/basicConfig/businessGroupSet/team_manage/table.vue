  ...
  <div class="box">
    <div class="list">
      ...
      <el-table height="100%" ref="multipleTable" :data="tableData" tooltip-effect="dark" header-align="center" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="userName" label="人员" width="180">
        </el-table-column>
        <el-table-column prop="userNo" label="员工编号" width="180">
        </el-table-column>
        <el-table-column prop="groupName" label="所属组" width="180">
        </el-table-column>
        ...
        <el-table-column prop="role" label="角色" width="180">
          <template slot-scope="scope">
            <span v-if="scope.row.role == 'leader'">组长</span>
            <span v-else-if="scope.row.role =='member'">组员</span>
          </template>
        </el-table-column>
        <el-table-column prop="type" label="岗位类型" width="140">
          <template slot-scope="scope">
            <span v-if="scope.row.type == 'FJ'">主岗</span>
            <span v-else-if="scope.row.type =='SPJ'">兼岗</span>
            <span v-else-if="scope.row.type =='DPJ'">其他</span>
          </template>
        </el-table-column>
