  ...
  <div class="box">
    <div class="list">
      ...
      <el-table height="100%" ref="multipleTable" :data="tableData" tooltip-effect="dark" header-align="center" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="rangeNo" label="派单范围编号">
        </el-table-column>
        <el-table-column prop="name" label="派单范围名称">
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="220">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="getGroupGoPage('二级设置',scope.row)">二级设置</el-button>
    ...
    <div class="pagination">
      <el-pagination @current-change="handleCurrentChange" :current-page="requestPage.page" layout="total, prev, pager, next, jumper" :total="requestPage.totalCount" :page-size="20">
      </el-pagination>
    </div>
  </div>
</template>
