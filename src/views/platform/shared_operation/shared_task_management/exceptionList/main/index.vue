<template>
  <div class="box">
    ...
    <btnComponent @refresh="onload" :btnList="btnList" @clickType="clickType" />
    <tableComponent :pageResult="pageResult" @handleCurrentChange="handleCurrentChange" :tableData="tableData" :clickFlag="clickFlag" :clickTypeTxt="clickTypeTxt" @getGroupGoPage="getGroupGoPage" />
  </div>
</template>
