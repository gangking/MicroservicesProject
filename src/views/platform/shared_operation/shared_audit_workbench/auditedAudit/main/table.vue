  ...
  <div class="box">
    <div class="list">
      ...
      <el-table height="100%" ref="multipleTable" :data="tableData" tooltip-effect="dark" header-align="center" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="status" label="稽核状态" width="180">
          <template slot-scope="scope">
        ...
        <el-table-column prop="bsDesc" label="业务场景描述">
        </el-table-column>
        <!-- <el-table-column prop="amount" label="单据金额" width="180">
        </el-table-column> -->
        <el-table-column prop="completeTime" label="稽核日期" width="180" :formatter="dateFormat">
        </el-table-column>
