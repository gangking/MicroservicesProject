<template>
  <div class="box">
    ...
    <tableComponent :NoOperation="true" :pageResult="pageResult" @handleCurrentChange="handleCurrentChange" :tableData="tableData" @getGroupGoPage="getGroupGoPage" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    ...mapActions(['reviseLoadingList']),
    onload() {
      this.reviseLoadingList({
        parameters: [],
        requestPage: {
