<template>
  <div class="box">
    ...
    <tableComponent @refresh="onload" :pageResult="pageResult" @handleCurrentChange="handleCurrentChange" @pendingCancelFunc="pendingCancelFunc" @handleSelectionChange="handleSelectionChange" :tableData="tableData" @getGroupGoPage="getGroupGoPage" />
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="30%" @close="closeDialog">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="taskAuditExtractionFunc">确认</el-button>
      </span>
    </el-dialog>
  ...
  methods: {
    ...
    taskAuditExtractionFunc() {
      if (JSON.stringify(this.activeGroupList) != '{}' && this.activeGroupList != null) {
        ...
        //   item['number'] = '';
        // }
        this.taskAuditExtraction(item).then(res => {
          this.onload();
