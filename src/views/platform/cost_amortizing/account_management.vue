  ...
  <div class="bg" ref="main" v-loading="bgLoading" element-loading-text="发送中,请等待">
    ...
    <div class="table-content" :style="{height:height+'px'}">
      ...
      >
        ...
        <el-table-column prop="amoSumWrbtr" label="摊销总额"></el-table-column>
    ...
    getAllTable() {
      ...
      getTable({
        ...
        parameters: [
          ...
          { key: "Q^EX_USERNO^SL", value: this.searchForm.exUserno },
          { key: "Q^EX_USERNAME^SL", value: this.searchForm.exUsername },
