<template>
  <!-- <div class="ub-body" style="height:500px;width:800px"> -->
  <ibps-layout ref="layout">
    ...
    >
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="条目设置" name="first">条目设置</el-tab-pane>
        <el-tab-pane label="业务类型" name="second">业务类型</el-tab-pane>
        <el-tab-pane label="功能区1" name="third">功能区1</el-tab-pane>
        <el-tab-pane label="功能区2" name="fourth">功能区2</el-tab-pane>
      </el-tabs>
    </div> <!-- step end -->
...
import step from './edit/detail/step'
