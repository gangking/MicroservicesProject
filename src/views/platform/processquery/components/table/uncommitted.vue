<template>
  <div class="tab">
    <div class="btn">
      <!-- <el-button size="mini" plain type="primary" class="elbtn" @click="agree">
        <i class="iconfont icon-uniE03F1 iconbtn" />
        <span class="icontext">同意</span>
      </el-button>
      <el-button size="mini" plain type="danger" class="elbtn" @click="reject">
        <i class="iconfont icon-uniE01E iconbtn" />
        <span class="icontext">驳回</span>
      </el-button> -->
      <div class="rightbtn">
        <el-dialog
    ...
    <div class="datatable">
      ...
      >
        ...
        <el-table-column prop="curNode" label="当前节点" sortable align="center" />
  ...
  methods: {
    ...
    agree() {
      return request({
        ...
        method: "post",
        data: {
          extraParameters: { buttonCode: "B0022" },
          parameters: [
            { key: "taskIds", value: this.taskIds },
            { key: "actionName", value: "agree" },
            { key: "opinion", value: "ok" }
          ]
        }
      }).then(res => {
        // console.log("res", res);
    ...
    reject() {
      return request({
        ...
        method: "post",
        data: {
          extraParameters: { buttonCode: "B0024" },
          parameters: [
            {
              key: "taskIds",
              value: this.taskIds
