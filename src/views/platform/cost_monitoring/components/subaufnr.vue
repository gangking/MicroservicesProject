<template>
  <div class="bg" id="monitoring-subaufnr" v-loading="bgLoading">
...
export default {
  ...
  methods: {
    ...
    routeTo(row) {
      ...
      this.monitorDetailObj["componet"] = "subaufnr";
    },
    //日期装换
    ...
    getTable(limit = 20, pageno = 1) {
      ...
      getSubaufnrReport(params).then(response => {
        this.loading = false;
