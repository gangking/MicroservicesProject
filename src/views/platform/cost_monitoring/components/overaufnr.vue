<template>
  <div class="bg" id="monitoring-overaufnr" v-loading="bgLoading">
    ...
    <div class="table-content" :style="{height:height+'px'}">
      ...
      >
        ...
        <el-table-column prop="totalCount" label="订单总数"></el-table-column>
        <el-table-column prop="totalPrice" label="订单总金额(万元)"></el-table-column>
        <el-table-column prop="cnfCOunt" label="已完工未收货数量"></el-table-column>
        <el-table-column prop="cnfprice" label="已完工未收货金额"></el-table-column>
        <el-table-column prop="dlvCount" label="已收货未报工数量"></el-table-column>
        <el-table-column prop="dlvprice" label="已收货未报工金额"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    routeTo(row) {
      ...
      this.monitorDetailObj["componet"] = "overaufnr";
    },
    //日期装换
    ...
    getTable(limit = 20, pageno = 1) {
      ...
      getOveraufnrReport(params).then(response => {
        this.loading = false;
