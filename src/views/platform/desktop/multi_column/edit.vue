      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="名称:" prop="name">
            <el-input
              v-if="!readonly"
              v-model="desktopColumn.name"
              v-pinyin="{vm:desktopColumn,key:'alias'}"
            />
        ...
        <el-col :span="12">
          <el-form-item label="别名:" prop="alias">
            <el-input v-if="!readonly" v-model="desktopColumn.alias" :disabled="formId!==''" />
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="栏目类型:" prop="colType">
            ...
            <el-tag
              v-else
              :type="desktopColumn.colType|optionsFilter(typeOptions,'type')"
            >{{ desktopColumn.colType|optionsFilter(typeOptions,'label') }}</el-tag>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="栏目分类:" prop="typeId">
            <ibps-type-select
              v-model="desktopColumn.typeId"
              category-key="DESKTOP_TYPE"
              clearable
              :readonly="readonly"
            />
          </el-form-item>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="公共栏目:" prop="isPublic">
            ...
            <el-tag
              v-else
              :type="desktopColumn.isPublic|optionsFilter(booleanOptions,'type')"
            >{{ desktopColumn.isPublic|optionsFilter(booleanOptions,'label') }}</el-tag>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="是否启用:" prop="isEnabled">
            ...
            <el-tag
              v-else
              :type="desktopColumn.isEnabled|optionsFilter(statusOptions,'type')"
            >{{ desktopColumn.isEnabled|optionsFilter(statusOptions,'label') }}</el-tag>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24">
          <el-form-item label="参数:" prop="parameters">
            <el-input v-if="!readonly" v-model="desktopColumn.parameters" type="textarea" rows="2" />
            <span v-else>{{ desktopColumn.parameters }}</span>
          </el-form-item>
        </el-col>
        <!-- <el-col :span="24">
...
<script>
import { save, get } from "@/api/platform/desktop/multiColumn";
import {
  typeOptions,
  statusOptions,
  dataModeOptions,
