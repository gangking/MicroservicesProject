<template>
  <el-dialog ref="dialog" :title="title" :visible.sync="dialogVisible" :close-on-click-modal="false" :fullscreen="fullscreen" class="desktop-preview-dialog" top="10vh" width="60%" @open="getFormData" @close="closeDialog">
    <div v-if="init" v-loading="dialogLoading" :element-loading-text="$t('common.loading')" class="ibps-desktop-page">
...
export default {
  ...
  methods: {
    ...
    getFormData() {
      ...
      this.components = dynamicImport(`@/views/platform/widget/components/${this.alias}`);
      this.init = true;
