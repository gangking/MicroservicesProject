            ...
            <span class="icon">
              <el-tooltip class="item" effect="light" placement="bottom">
                <div slot="content">
                  ...
                  系统名org，模块名org，是否基础模块为'是'则生成包名为com.pactera.ibps.org；<br>
                  是否基础模块为'否'则生成包名为com.pactera.ibps.org.org；</div>
                <ibps-icon name="help" />
              </el-tooltip>:
            </span>
  ...
  data() {
    return {
      ...
      form: {
        ...
        developer: '',
        email: '',
        packageUrl: 'com.pactera.ibps.demo',
        menuUrl: '/demo/codegen//list',
        comment: '',
