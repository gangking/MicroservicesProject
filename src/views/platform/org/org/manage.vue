    ...
    <div slot="west">
      ...
      <ibps-container :margin-left="width+'px'"
        ...
        <detail v-if="show==='detail'"
                ...
                :is-tree-all="false"
                :is-edit="true" />
        <edit v-else-if="show==='edit'"
              :id="orgId"
              :parent-id="parentId"
              @callback="search"
              @success="successCallback" />

        <edit-position v-else-if="show==='addPosition'"
                       :org-id="orgId"
                       :parent-id="parentId"
      ...
      <!--设置管理员-->
      <auth-edit :visible="authEditVisible"
                 :org-id="orgId"
                 :org-name="orgName"
...
<script>
import { findTreeData, newFindTreeData, remove } from '@/api/platform/org/org'
...
import IbpsOrgTree from '../../../../components/ibps-tree/ibps-org-tree'
