  ...
  >
    ...
    >
      ...
      <el-form-item v-if="formDef.mode==='bo'" label="业务对象:" prop="code">
        <bo-def-selector v-model="formDef.code" value-key="code" @change="handleCodeDef" />
      </el-form-item>
      ...
      <el-form-item label="表单构建模式::" prop="buildMode">
        <el-select v-model="formDef.buildMode" style="width:100%;">
          <el-option value="empty" label="空模版" />
...
export default {
  ...
  methods: {
    ...
    // 下一步数据
    nextData() {
      if (this.formDef.buildMode === 'default' || this.formDef.buildMode === 'empty') {
        this.design()
      } else {
        // TODO: 其他类型
      }
