<template>
  <div class="tabsBox">
    ...
    <div class="content">
      <div class="rule"
           v-show="activeName == 'EffectiveInspection' || activeName == 'Prerequisite'"
           @click="ruleBlur(form.formtype)">
        <code-codemirror :fromVariable="form.variable"
                         :fromFunc="form.func"
                         :thisValue="form.value"
