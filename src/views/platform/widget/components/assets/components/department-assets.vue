    ...
    <div class="title">
      ...
      <div>
        <el-input
          ...
          clearable
          placeholder="请输入保管人名字"
        ></el-input>
      </div>
      <div>
        <el-link type="primary" class="assetsDown" @click="handler('downExcel')">导出明细</el-link>
        <!-- <span class="assetsDown" @click="handler('downExcel')">导出</span> -->
      ...
      <div v-if="tableData.length>0">
        <div class="list-item" v-for="(list,index) in tableData" :key="index">
          <div class="left">
            ...
            <div class="detail">
              <div class="top">{{list.TXT50}}丨保管人：{{list.ZZNAME1}}</div>
              <div class="bottom">
...
<script>
import { getBmzc, getUserNo, downExcel } from "@/api/platform/assets/assets";
