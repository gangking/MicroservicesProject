...
<script>
import { getByxzsyxz } from "@/api/platform/bill/bill";
export default {
  props: {
    componInfo: {
      type: Object,
  ...
  data() {
    return {
      bgImg: {
        backgroundImage:
          "url(" + require("@/assets/images/bill_rank/add.png") + ")",
  ...
  methods: {
    initData() {
      getByxzsyxz({
        ...
        this.number = res.data.byxzdjl;
        this.percentage = res.data.byxzdjlbl;
      });
    },
    //获取当前日期
    getNowFormatDate() {
