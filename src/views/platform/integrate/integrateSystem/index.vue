    ...
    <div class="header-input" ref="header_input">
      <el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="80px">
        ...
        <el-form-item label="系统编码" prop="sysCode">
          <el-input v-model="ruleForm.SYS_CODE" placeholder="请输入系统编码" clearable></el-input>
        </el-form-item>
        <el-form-item label="系统描述" prop="sysDesc">
          <el-input v-model="ruleForm.SYS_DESC" placeholder="请输入系统描述" clearable></el-input>
        </el-form-item>
      </el-form>
    </div>
    <!--  -->
...
import {
  ...
  integSysAddEdit,
  integSysRemove
} from "@/api/platform/integrate/system";
import integrateDialog from "@/views/platform/integrate/integrateSystem/components/dialog";
