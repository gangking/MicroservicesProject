<template>
  ...
  >
    ...
    <el-form-item prop="area">
      <ibps-address-cascader v-model="loginForm.address" :data="areaData" level="province" top-val="86" />
    </el-form-item>
  ...
  methods: {
    ...
    handleRegister() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          this.loginForm.area = this.loginForm.address.join(',')
